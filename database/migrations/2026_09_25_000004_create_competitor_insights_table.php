...
return new class() extends Migration
{
    ...
    {
        Schema::create('competitor_insights', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('client_id')->constrained();
            $table->foreignId('competitor_id')->constrained();
            $table->json('competitor_source_ids')->nullable();
            $table->foreignId('competitor_research_run_id')->nullable()->constrained();
            ...
            $table->index(['competitor_id', 'status', 'type']);
        });
    }
