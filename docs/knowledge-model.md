...
- `knowledge_sources`: material original ingresado al sistema. Cada página web leída, posteo de
  Instagram, anuncio de Meta, reseña de Google, conversación de WhatsApp con un cliente, foto o documento subido
  es una fuente.
...
El esquema prevé además `audio` y `adjustment`, todavía sin uso.
...
| Campo | Sitio web | Instagram | Anuncios de Meta | Reseñas de Google | WhatsApp | Fotos y documentos |
| --- | --- | --- | --- | --- | --- | --- |
| `name` | Si está vacío | | | | | |
| `brand_offer_description` | Mezcla | | Mezcla | Mezcla | | Si cambia |
| `brand_differentiators_description` | Mezcla | | Mezcla | Mezcla | | Si cambia |
| `brand_history_description` | Mezcla | | | | | Si cambia |
| `brand_customers_description` | Mezcla | Mezcla | Mezcla | Mezcla | Mezcla | Si cambia |
| `brand_customers_needs_description` | Mezcla | Mezcla | Mezcla | Mezcla | Mezcla | Si cambia |
...
| `brand_content_opportunities_description` | Mezcla | | Mezcla | Mezcla | Mezcla | Si cambia |
| `brand_logos`, `brand_colors`, `brand_fonts` | Si está vacío | | | | | |

Las pantallas de Instagram, de anuncios, de reseñas, de chats de WhatsApp y de fotos y documentos muestran qué campos
del perfil actualizó su último análisis: los que el modelo devolvió con texto en `payload.brand`.
