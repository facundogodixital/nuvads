...
class ResearchCompetitorGoogleReviewsJob implements ShouldQueue
{
    ...
    {
        $this->logInfo('Starting ResearchCompetitorGoogleReviewsJob.', ['attempt' => $this->attempts()]);
        ...
        $researchRun = resolve(CompetitorGoogleReviewsResearchService::class)->research(
    ...
    private function logInfo(string $message, array $context = []): void
    {
        ...
        Log::channel('ResearchCompetitorGoogleReviewsJobInfo')->info("[{$this->logUuid}] | {$message}", $context);
    }
    ...
    {
        $context = ['researchRunId' => $this->researchRunId, ...$context];
        foreach (['ResearchCompetitorGoogleReviewsJobInfo', 'ResearchCompetitorGoogleReviewsJobErrors'] as $channel) {
