...
class ResearchCompetitorMetaAdsJob implements ShouldQueue
{
    ...
    {
        $this->logInfo('Starting ResearchCompetitorMetaAdsJob.', ['attempt' => $this->attempts()]);
        ...
        $researchRun = resolve(CompetitorMetaAdsResearchService::class)->research(
    ...
    public function failed(Throwable $exception): void
    {
        ...
        resolve(CompetitorResearchRunService::class)->fail(
            $this->researchRunId, 'No se pudo completar el análisis de los anuncios.',
        );
    }
    ...
    private function logInfo(string $message, array $context = []): void
    {
        ...
        Log::channel('ResearchCompetitorMetaAdsJobInfo')->info("[{$this->logUuid}] | {$message}", $context);
    }
    ...
    {
        $context = ['researchRunId' => $this->researchRunId, ...$context];
        foreach (['ResearchCompetitorMetaAdsJobInfo', 'ResearchCompetitorMetaAdsJobErrors'] as $channel) {
