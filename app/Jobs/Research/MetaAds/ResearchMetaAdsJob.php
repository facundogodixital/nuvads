...
namespace App\Jobs\Research\MetaAds;
...
class ResearchMetaAdsJob implements ShouldQueue
{
    ...
    {
        $this->logInfo('Starting ResearchMetaAdsJob.', ['attempt' => $this->attempts()]);
        ...
        $researchRun = resolve(MetaAdsResearchService::class)->research(
    ...
    private function logInfo(string $message, array $context = []): void
    {
        ...
        Log::channel('ResearchMetaAdsJobInfo')->info("[{$this->logUuid}] | {$message}", $context);
    }
    ...
    {
        $context = ['researchRunId' => $this->researchRunId, ...$context];
        foreach (['ResearchMetaAdsJobInfo', 'ResearchMetaAdsJobErrors'] as $channel) {
